...
Before starting the lab, pull in the log-start task.
   ...
   git checkout -b 'logging' 'log-solution'
...
. In AKS cluster the application ready time would be delayed. The application would be ready after 150 seconds as the readiness probe would start after 150 seconds
